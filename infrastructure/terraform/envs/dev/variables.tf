...
variable "region" {
  description = "AWS region for the dev landing zone."
  type        = string
  default     = "eu-west-1"
}
...
variable "public_subnet_cidrs" {
  ...
  type        = list(string)
  default     = ["10.60.0.0/24", "10.60.1.0/24", "10.60.2.0/24"]
}

variable "private_app_subnet_cidrs" {
  description = "Application subnets, one per AZ. ECS tasks (WS4)."
  type        = list(string)
  default     = ["10.60.16.0/20", "10.60.32.0/20", "10.60.48.0/20"]
}

variable "private_data_subnet_cidrs" {
  description = "Data subnets, one per AZ. Aurora (WS3) and MSK (WS6)."
  type        = list(string)
  default     = ["10.60.64.0/22", "10.60.68.0/22", "10.60.72.0/22"]
}
...
variable "domain_name" {
  ...
  type        = string
  default     = "fineract-dev.example.com"
}
...
variable "api_record_name" {
  ...
  type        = string
  default     = "api.fineract-dev.example.com"
}
